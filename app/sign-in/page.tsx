...
export default function SignInPage() {
  ...
  return (
    ...
    >
      <div
        className="
          relative flex h-[calc(100vh-20px)] overflow-hidden rounded-[28px]
          border border-white/70 bg-[#FCFCFB] shadow-[0_20px_60px_rgba(60,45,110,.10)]
        "
      >
        {/* MAC CONTROLS */}
        ...
        <section
          className="
            relative hidden w-[40%] overflow-hidden border-r border-[#EAE7EE]
            lg:flex lg:flex-col lg:justify-center lg:px-[4vw]
          "
          style={{
            background: `
        ...
        >
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[27px] leading-none text-[#7565F5]">✦</span>
            </div>
        ...
        <section className="relative flex flex-1 items-center justify-center bg-[#FCFCFB] px-6 py-6 lg:px-10">
            ...
            {mode === "signin" ? (
              <>
                ...
                <button
                  ...
                  className="
                    rounded-full border border-[#E4E2E7] bg-white/70 px-3.5 py-1.5
                    font-medium text-[#303036] shadow-[0_2px_8px_rgba(0,0,0,.03)]
          ...
          <div className="w-full max-w-[390px]">
            ...
            <div className="mb-5">
              <h1 className="text-[29px] font-semibold leading-[1.05] tracking-[-0.045em] text-[#171719]">
                {mode === "signin" ? "Welcome to your" : "Create your"}
              </h1>
              <div className="mt-0.5 flex items-center gap-2">
                <span className="text-[29px] font-semibold leading-[1.05] tracking-[-0.045em] text-[#7565F5]">
                  {mode === "signin" ? "journey" : "account"}
                </span>
                <span className="text-[23px] leading-none text-[#7565F5]">✦</span>
              </div>
              <p className="mt-3 max-w-[285px] text-[13px] leading-[19px] text-[#9696A5]">
                {mode === "signin" ? (
                  <>Let&apos;s build a voice you trust,<br />one conversation at a time.</>
                ) : (
                  <>Start your journey toward a voice<br />you trust and a mind at ease.</>
                )}
              </p>
            </div>
            ...
            {mode === "signin" && (
              <>
                ...
                <div className="my-4 flex items-center gap-4">
                  ...
                  <span className="text-[10px] text-[#9999A2]">or</span>
                  <div className="h-px flex-1 bg-[#E6E4E8]" />
                </div>
              </>
            )}
            ...
            {/* SUCCESS BANNER */}
            {signupSuccess ? (
              <p className="rounded-[12px] border border-[#D1FAE5] bg-[#ECFDF5] px-4 py-3 text-[13px] leading-[19px] text-[#065F46]">
              ...
              <>
                ...
                {mode === "signup" && (
                  <div className="mb-2.5">
                    <div className="mb-1.5">
                      <label htmlFor="name" className="text-[12px] font-medium text-[#39393E]">
                        Full name
                      </label>
                    </div>
                    <input
                      ...
                      className="
                        h-[44px] w-full rounded-[12px] border border-[#E4E3E7] bg-white
                        px-4 text-[13px] text-[#27272B] outline-none
                        shadow-[0_2px_7px_rgba(0,0,0,.025)] transition
                        placeholder:text-[#B2B2BA] focus:border-[#B9B2F2]
                        focus:ring-4 focus:ring-[#7565F5]/[0.07]
                      "
                    />
                  </div>
                )}
                ...
                <div className="mb-1.5 flex items-center justify-between">
                  <label htmlFor="email" className="text-[12px] font-medium text-[#39393E]">
                    Email address
                  </label>
                  {mode === "signin" && (
                    <button
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="
                      h-[44px] w-full rounded-[12px] border border-[#E4E3E7] bg-white
                      pl-10 pr-4 text-[13px] text-[#27272B] outline-none
                      shadow-[0_2px_7px_rgba(0,0,0,.025)] transition
                      placeholder:text-[#B2B2BA] focus:border-[#B9B2F2]
                      focus:ring-4 focus:ring-[#7565F5]/[0.07]
                    "
                ...
                <div className="mt-2.5">
                  <div className="mb-1.5 flex items-center justify-between">
                    <label htmlFor="password" className="text-[12px] font-medium text-[#39393E]">
                      Password
                    </label>
                    {mode === "signin" && (
                      <button
                ...
                {mode === "signup" && (
                  <div className="mt-2.5">
                    <div className="mb-1.5">
                      <label htmlFor="confirmPassword" className="text-[12px] font-medium text-[#39393E]">
                        Confirm password
                      </label>
                    </div>
                    <input
                ...
                <button
                  ...
                  disabled={loading}
                  className="
                    mt-2.5 flex h-[46px] w-full items-center justify-center gap-2.5
                    rounded-[12px] bg-[#292A2E] text-[13px] font-medium text-white
                    shadow-[0_7px_20px_rgba(25,25,30,.12)] transition hover:bg-[#1F2023]
                    disabled:opacity-60
                  "
                >
                  {loading
          ...
          <div
            className="
              pointer-events-none absolute -bottom-14 -right-10
              h-[140px] w-[140px] rounded-full opacity-50 blur-[42px]
            "
            style={{
              background:
